...
const etsyShopReadinessStateDefinitionCreate = async (
  credsPayload,
  createPayload,
  {
    shopId,
  ...
  return fetchClient.fetch({
    requestPayload: {
      method: 'post',
      url: `/application/shops/${ shopId }/readiness-state-definitions`,
      body: createPayload,
    },
    context: {
      credsPayload,
...
module.exports = {
  etsyShopReadinessStateDefinitionCreate,
  funcApiConfig,
};

/*
curl -X POST "http://localhost:8000/etsyShopReadinessStateDefinitionCreate" \
