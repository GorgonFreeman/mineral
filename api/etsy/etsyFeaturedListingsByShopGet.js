...
const etsyFeaturedListingsByShopGet = async (
  returnGetter,
  ...
  const getterArgs = [
    credsPayload,
    `/application/shops/${ shopId }/listings/featured`,
    {
      params,
      perPage,
      withAccessToken,
...
module.exports = {
  etsyFeaturedListingsByShopGet: (...args) => etsyFeaturedListingsByShopGet(false, ...args),
