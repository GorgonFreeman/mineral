...
const etsyShopProductionPartnersGet = async (
  credsPayload,
  {
    shopId,
    params,
  ...
  return etsyClient.fetch({
    requestPayload: {
      method: 'get',
      url: `/application/shops/${ shopId }/production-partners`,
      ...(params && { params }),
    },
    context: {
      credsPayload,
...
module.exports = {
  etsyShopProductionPartnersGet,
  funcApiConfig,
};

/*
curl -X POST "http://localhost:8000/etsyShopProductionPartnersGet" \
