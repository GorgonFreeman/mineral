...
const etsyListingPropertiesGet = async (
  credsPayload,
  listingId,
  {
    shopId,
  ...
  return etsyClient.fetch({
    requestPayload: {
      method: 'get',
      url: `/application/shops/${ shopId }/listings/${ listingId }/properties`,
      ...(params && { params }),
    },
    context: {
      credsPayload,
...
module.exports = {
  etsyListingPropertiesGet,
  funcApiConfig,
};

/*
curl -X POST "http://localhost:8000/etsyListingPropertiesGet" \
