...
const etsyAllListingFilesGet = async (
  credsPayload,
  listingId,
  {
    shopId,
  ...
  return etsyClient.fetch({
    requestPayload: {
      method: 'get',
      url: `/application/shops/${ shopId }/listings/${ listingId }/files`,
      ...(params && { params }),
    },
    context: {
      credsPayload,
...
module.exports = {
  etsyAllListingFilesGet,
  funcApiConfig,
};

/*
curl -X POST "http://localhost:8000/etsyAllListingFilesGet" \
