...
const etsyPaymentAccountLedgerEntryPaymentsGet = async (
  credsPayload,
  {
    shopId,
    params,
...
module.exports = {
  etsyPaymentAccountLedgerEntryPaymentsGet,
  funcApiConfig,
};

/*
curl -X POST "http://localhost:8000/etsyPaymentAccountLedgerEntryPaymentsGet" \
